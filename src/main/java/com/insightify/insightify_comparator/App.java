...
import com.insightify.insightify_comparator.data_management.*;
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int i=0; i<products_to_compare;i++){
            ...
            if(app.handler.asin_exists(asin)){
                ...
                result.put(asin, app.handler.get_product_composite_score(asin));
            }else{
        ...
        for(String asin_2: asins_to_add_to_database){
            result.put(asin, app.handler.get_product_composite_score(asin_2));
        }
        // Display Result
